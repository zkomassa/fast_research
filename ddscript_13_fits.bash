...
#A script to process single .fits data files through the PRESTO pipeline.

#command line arguments are in the format: ddscript_[n]_fits.bash directory filename
